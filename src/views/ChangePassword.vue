<template>
  ...
  <section class="section-about">
    <h2 class="text-center mb-4">تغيير كلمه المرور</h2>
    <div class="img-iphone-box">
      <img class="img-iphone" src="../assets/imgiphone.jpg" />
      <h4 class="title-all-forms">برجاء ادخال كلمة المرور القديمة و الجديدة</h4>
      <form class="content-form">
        <div class="mb-4 position-relative">
          <label class="label-content"
            >كلمة المرور القديمه <span class="red">*</span></label
          >
          <input
        ...
        <div class="mb-4 position-relative">
          <label class="label-content"
            >كلمة المرور الجديده <span class="red">*</span></label
          >
          <input
            class="input-all input-content input-profile input-pass"
            placeholder="الرجاء ادخال إسم المستخدم"
        ...
        <a
          href="http://localhost:8080/?#/SettingsVue"
